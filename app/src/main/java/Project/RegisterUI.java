...
public class RegisterUI {
    public RegisterUI(Stage primaryStage) {
        ...
        usernameField.setId("usernameFieldistor");
        passwordField.setId("passwordFieldistor");
        registerButton.setId("registerButtonistor");
        messageLabel.setId("messageLabelistor");
